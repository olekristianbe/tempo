...
Task management for people who finish things. Fast, opinionated, and built for small teams.
...
- **Desktop-native** — Real macOS app with menu bar, deep links, and auto-updates.
...
- **Quick-add** — Global shortcut to capture tasks without switching windows
- **Command palette** — Navigate, create, and search from anywhere
- **In-app feedback** — Report bugs or suggest features directly from the app
...
1. Download the latest `.dmg` from [GitHub Releases](https://github.com/olekristianbe/tempo/releases/latest)
2. Open `Tempo-x.x.x-arm64.dmg`
3. Drag Tempo.app to Applications
...
Tempo checks for updates automatically and shows a banner in the sidebar when a new version is ready. You can also check manually via Tempo → Check for Updates.

## Support

- [Report Issues](https://github.com/olekristianbe/tempo/issues)
